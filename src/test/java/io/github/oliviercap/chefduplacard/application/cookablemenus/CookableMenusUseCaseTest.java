...
class FakeRecipeRepository implements IRecipeRepository {
    ...
    private final Aliment aliment4 = new Aliment(new AlimentId(Long.valueOf(1)), "cherry", "fruit", true);
    private final Aliment aliment5 = new Aliment(new AlimentId(Long.valueOf(1)),"apricot", "fruit", true);
    private final Aliment aliment6 = new Aliment(new AlimentId(Long.valueOf(1)),"pear", "fruit", true);
    private final Aliment aliment7 = new Aliment(new AlimentId(Long.valueOf(1)), "plum", "fruit", true);
    ...
    private final Ingredient ingredient4 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(2), aliment4, unit);
    private final Ingredient ingredient5 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(12), aliment5, unit);
    private final Ingredient ingredient6 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(3), aliment6, unit);
    private final Recipe recipe3 = new Recipe(new RecipeId(Long.valueOf(1)),"r3", "a", Duration.ofMinutes(1), "1", List.of(ingredient4, ingredient5, ingredient6));

    private final Ingredient ingredient7 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(4), aliment7, unit);
    private final Recipe recipe4 = new Recipe(new RecipeId(Long.valueOf(1)),"r4", "a", Duration.ofMinutes(1), "1", List.of(ingredient7));

    private final Ingredient ingredient2_2 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(5), aliment2, unit);
    private final Ingredient ingredient4_2 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(23), aliment4, unit);
    private final Recipe recipe5 = new Recipe(new RecipeId(Long.valueOf(1)),"r5", "a", Duration.ofMinutes(1), "1", List.of(ingredient2_2, ingredient4_2));

    private final Ingredient ingredient2_3 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(8), aliment2, unit);
    private final Ingredient ingredient4_3 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(2), aliment4, unit);
    private final Ingredient ingredient6_3 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(3), aliment6, unit);
    private final Recipe recipe6 = new Recipe(new RecipeId(Long.valueOf(1)),"r6", "a", Duration.ofMinutes(1), "1", List.of(ingredient2_3, ingredient4_3, ingredient6_3));

    private final Ingredient ingredient3_4 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(1), aliment3, unit);
    private final Ingredient ingredient5_4 = new Ingredient(new IngredientId(Long.valueOf(1)),BigDecimal.valueOf(9), aliment5, unit);
    private final Recipe recipe7 = new Recipe(new RecipeId(Long.valueOf(1)),"r7", "a", Duration.ofMinutes(1), "1", List.of(ingredient3_4, ingredient5_4));
...
class FakeStockRepository implements IStockRepository {
    ...
    private final StockLine stockLine1 = new StockLine(new StockLineId(Long.valueOf(1)),BigDecimal.valueOf(0), aliment1, unit);
    private final StockLine stockLine2 = new StockLine(new StockLineId(Long.valueOf(1)),BigDecimal.valueOf(18), aliment2, unit);
    private final StockLine stockLine3 = new StockLine(new StockLineId(Long.valueOf(1)),BigDecimal.valueOf(7), aliment3, unit);
    private final StockLine stockLine4 = new StockLine(new StockLineId(Long.valueOf(1)),BigDecimal.valueOf(27), aliment4, unit);
    private final StockLine stockLine5 = new StockLine(new StockLineId(Long.valueOf(1)),BigDecimal.valueOf(21), aliment5, unit);
    private final StockLine stockLine6 = new StockLine(new StockLineId(Long.valueOf(1)),BigDecimal.valueOf(6), aliment6, unit);
    private final StockLine stockLine7 = new StockLine(new StockLineId(Long.valueOf(1)),BigDecimal.valueOf(0), aliment7, unit);

    @Override
    public Optional<Stock> findById(Long stockId) {
        return Optional.of(new Stock(new StockId(Long.valueOf(1)),"test", List.of(
                stockLine1,
                stockLine2,
                stockLine3,
                stockLine4,
